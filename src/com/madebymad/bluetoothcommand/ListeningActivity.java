...
public class ListeningActivity extends Activity {
    ...
    private BluetoothTalkService mTalkService = null;
    ...
    public void onStart() {
        ...
        // Otherwise, setup the chat session
            ...
            if (mTalkService == null) setupTalk();
        }
        ensureDiscoverable();
    }
    ...
    public synchronized void onResume() {
        ...
        if (mTalkService != null) {
            ...
            if (mTalkService.getState() == BluetoothTalkService.STATE_NONE) {
    ...
    public void onDestroy() {
        ...
        if (mTalkService != null) mTalkService.stop();
    ...
    private void setupTalk() {
        ...
        mTalkService = new BluetoothTalkService(this, mHandler);
 ...
 // The Handler that gets information back from the BluetoothTalkService
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_DEVICE_NAME:
                ...
                if(D) Log.i(TAG, "mConnectedDeviceName : " + mConnectedDeviceName);
    ...
    private void sendMessage(String message) {
        ...
        if (mTalkService.getState() != BluetoothTalkService.STATE_CONNECTED) {
